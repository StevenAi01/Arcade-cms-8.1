                    ...
                    if (isset($_FILES['__game_image']['tmp_name'])) {
                        if (isset($_FILES['__game_image']['tmp_name'])) {
                            if ($_FILES['__game_image']['size'] > 1024) {
                                ...
                                $GameMonetizeConnect->query("INSERT INTO " . CATEGORIES . " (category_pilot, name,  image, footer_description, show_home) VALUES ('{$seo_name}','{$category_name}', '{$addgame_mediaurl}', '{$category_footer_description}', {$ec_show_home})");
                        ...
                        $GameMonetizeConnect->query("INSERT INTO " . CATEGORIES . " (category_pilot, name, footer_description, show_home) VALUES ('{$seo_name}','{$category_name}','{$category_footer_description}', {$ec_show_home})");
                        addCategoryXml($seo_name);
                    }
